...
describe('Anagram#word_test') do
  ...
  # end
  #
  # it('will return a message telling the user to enter a sentence with the same amount of words') do
  #   try_again = Anagram.new("cool how are you", "pool i am awesome today")
  #   expect(try_again.word_test).to(eq("Enter the same amount of words per sentence."))
  # end

  it('will return a message telling the user how many antigrams they have and anagrams') do
    full_sentence = Anagram.new("cool mom", "pool mom")
    expect(full_sentence.word_test).to(eq("Enter the same amount of words per sentence."))
  end
